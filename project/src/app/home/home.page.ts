...
export class HomePage implements OnInit {
  ...
  flag = 0;
  searchText = ""
  constructor(public autoCompleteLabelsService: AutoCompleteLabelsService, public e: Events, private zone: NgZone, private alertCtrl: AlertController, @Inject(LOCALE_ID) private locale: string, private router: Router, private calendarS: CalendarService, private mealS: MealService) {
